...
gfortran -std=legacy SPEED2.FOR -o SPEED2 && echo "Успех!" || echo "Ошибка!"

echo "Fortran (new version):"
gfortran NEWSPEED2.f90 -o NEWSPEED2 && echo "Успех!" || echo "Ошибка!"

echo "C:"
gcc speedtest_c.c -o speedtest_c && echo "Успех!" || echo "Ошибка!"

echo "C++:"
g++ speedtest_cpp.cpp -o speedtest_cpp && echo "Успех!" || echo "Ошибка!"

echo "Java:"
javac speedtest_java.java && echo "Успех!" || echo "Ошибка!"

echo "Pascal:"
fpc speedtest_pascal.pas && echo "Успех!" || echo "Ошибка!"
